...
function ssr(){
    ...
    service docker restart
        ...
        echo "-----------------------------------------------------"
        echo
        read -p "Please input KEY(Default Key:TzCloudhuahua123)：" muKey
        [ -z "${muKey}" ] && muKey=TzCloudhuahua123
        echo
        echo "-----------------------------------------------------"
        echo "muKey = ${muKey}"
        echo "-----------------------------------------------------"
...
#Setting_Docking
    ...
    echo "-----------------------------------------------------"
    echo
    read -p "Please input URL(Default Url:https://www.jisutizi.xyz)：" Dockerurl
    [ -z "${Dockerurl}" ] && Dockerurl=https://www.jisutizi.xyz
    echo
    echo "-----------------------------------------------------"
    echo "dockerurl = ${Dockerurl}"
    echo "-----------------------------------------------------"
    echo
    read -p "Please input KEY(Default Key:TzCloudhuahua123)：" Dockerkey
    [ -z "${Dockerkey}" ] && Dockerkey=TzCloudhuahua123
    echo
    echo "-----------------------------------------------------"
